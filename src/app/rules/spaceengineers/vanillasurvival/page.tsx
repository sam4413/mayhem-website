...
export default function RulesSpaceeEngineersVanillaSurvival() {
  return (
    <div className="relative overflow-hidden">
      ...
      <main className="grid grid-cols-1 md:grid-cols-1 gap-8 relative z-10 ml-8 mr-8 lg:ml-36 lg:mr-36 xl:ml-96 xl:mr-96">
        ...
        headerProperies={"mt-4 mb-4 p-8 text-left text-purple-500 orbitron-900 border-2 border-blue-500 hover:scale-103 hover:border-purple-500"}
